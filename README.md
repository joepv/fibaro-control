...
Just select the file `Fibaro.Contol.exe` from the assets if you just want to use the program.

![Login Screen](Documentation/Image004.png "Fibaro Control: Login Screen")
